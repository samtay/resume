...
\section{EXPERIENCE}
  ...
  \begin{itemize}  \itemsep -2pt %reduce space between items
    \item apprentice -> senior achievement
    \item contributions to internal infastructure such as deployment
      tools and docker management scripts
    \item extensive magento and magento2 development
  \end{itemize}
