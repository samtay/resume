...
%% Name
% Original format was medskip instead of negative vspace, this keeps things
% aligned. Need to decide which is better.
\vspace{-.69in} %\medskip
\noindent{\LARGE\scheader \textsc{samuel tay}} \\

\vspace{-.03in} %\medskip
\footnotesize
  \noindent 852 Centerwood Drive \\
...
\begin{itemize}
  \item Developed reusable modules in an object oriented MVC eCommerce
    framework.
  \item Contributed to infastructure in the form of deployment tools and a
    docker composition-machine management tool.
