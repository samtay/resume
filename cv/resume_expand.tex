...
\section{EDUCATION}
  ...
  {\sl Major}: Mathematics; {\sl Minor}: Scientific Computing \\
  {\sl GPA}: 3.91

\section{COMPUTER \\ SKILLS}
  {\sl Languages}: Fluent in PHP, Javascript, and C++. Experience with Bash, Python, C. \\
  {\sl Software}: Mastery of Magento and development tools such as git, vim, tmux.
    Experience with technologies such as Docker, NodeJS, Symfony, MySQL, RabbitMQ. \\
