...
\ind M.S., Computer Science \hfill {\small 2020 - Present}

\noindent University of Washington \hfill {\small Seattle, WA} \\
\ind \footnotesize
  Courses: Applied Cryptography, Formal Verification, Network Systems, etc. \\
  Current GPA: 4.00 \\
...
\ind \emph{Senior Software Engineer} \hfill {\small Apr 2022 - Present}
{\vskip 0.1em}
\ind Phylum \hfill {\small Remote}
\small
\begin{itemize}
  \item Developed APIs for multiple consumers (web \& CLI) to interact with our open source
    package scoring data.
